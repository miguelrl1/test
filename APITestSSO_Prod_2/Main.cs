/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘APITestSSO_Prod_2.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            binding_setter1 = new StringFormaterDecorator(binding_setter1,"{Step.DataFetchActivity23.OutTable}");
            bind_dir1 = new BindDirection(_flow.DataFetchActivity23,binding_getter1,binding_setter1,BindTargetType.ToInProperty);
            _flow.DataExporterActivity25.InDirections.Add(bind_dir1);
            ...
            binding_setter2 = new StringFormaterDecorator(binding_setter2,"{Step.DataFetchActivity23.OutTable}");
            bind_dir2 = new BindDirection(_flow.DataFetchActivity23,binding_getter2,binding_setter2,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity24.InDirections.Add(bind_dir2);
            ...
            binding_setter3 = new StringFormaterDecorator(binding_setter3,"{Step.DataFetchActivity23.OutTable}");
            bind_dir3 = new BindDirection(_flow.DataFetchActivity23,binding_getter3,binding_setter3,BindTargetType.ToInProperty);
            this.DataCursorActivity27.InDirections.Add(bind_dir3);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            VTDPropertyInfoBase pi8 = new VTDPropertyInfoBase("Input.password");
            VTDBaseSetter binding_setter4 = new VTDObjectSetter(pi8);
            binding_setter4 = new StringFormaterDecorator(binding_setter4,"{DataSource.Users.password}");
            bind_dir4 = new BindDirection(this.DataCursorActivity27,binding_getter4,binding_setter4,BindTargetType.ToInProperty);
            _flow.RESTActivityV28.InDirections.Add(bind_dir4);
            VTDPropertyInfoBase pi9 = new VTDPropertyInfoBase("idUser");
            VTDBaseGetter binding_getter5 = new VTDObjectGetter(pi9);
            VTDPropertyInfoBase pi10 = new VTDPropertyInfoBase("Input.idUser");
            VTDBaseSetter binding_setter5 = new VTDObjectSetter(pi10);
            binding_setter5 = new StringFormaterDecorator(binding_setter5,"{DataSource.Users.idUser}");
            bind_dir5 = new BindDirection(this.DataCursorActivity27,binding_getter5,binding_setter5,BindTargetType.ToInProperty);
            _flow.RESTActivityV28.InDirections.Add(bind_dir5);
            VTDPropertyInfoBase pi11 = new VTDPropertyInfoBase("Input.idUser");
            VTDBaseGetter binding_getter6 = new VTDObjectGetter(pi11);
            VTDPropertyInfoBase pi12 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter6 = new VTDObjectSetter(pi12);
            binding_setter6 = new StringFormaterDecorator(binding_setter6,"{Step.RESTInputProperties.RESTActivityV28.idUser}");
            bind_dir6 = new BindDirection(_flow.RESTActivityV28,binding_getter6,binding_setter6,BindTargetType.ToInProperty);
            _flow.RESTActivityV28.InDirections.Add(bind_dir6);
            VTDPropertyInfoBase pi13 = new VTDPropertyInfoBase("Input.password");
            ...
            binding_setter7 = new StringFormaterDecorator(binding_setter7,"{Step.RESTInputProperties.RESTActivityV28.password}");
            bind_dir7 = new BindDirection(_flow.RESTActivityV28,binding_getter7,binding_setter7,BindTargetType.ToInProperty);
            _flow.RESTActivityV28.InDirections.Add(bind_dir7);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV212.Input.idUser = @"{DataSource.Users.idUser}";
            _flow.RESTActivityV212.Input.password = @"{DataSource.Users.password}";
            VTDPropertyInfoBase pi15 = new VTDPropertyInfoBase("password");
            VTDBaseGetter binding_getter8 = new VTDObjectGetter(pi15);
            VTDPropertyInfoBase pi16 = new VTDPropertyInfoBase("Input.password");
            VTDBaseSetter binding_setter8 = new VTDObjectSetter(pi16);
            binding_setter8 = new StringFormaterDecorator(binding_setter8,"{DataSource.Users.password}");
            bind_dir8 = new BindDirection(this.DataCursorActivity27,binding_getter8,binding_setter8,BindTargetType.ToInProperty);
            _flow.RESTActivityV212.InDirections.Add(bind_dir8);
            VTDPropertyInfoBase pi17 = new VTDPropertyInfoBase("idUser");
            VTDBaseGetter binding_getter9 = new VTDObjectGetter(pi17);
            VTDPropertyInfoBase pi18 = new VTDPropertyInfoBase("Input.idUser");
            VTDBaseSetter binding_setter9 = new VTDObjectSetter(pi18);
            binding_setter9 = new StringFormaterDecorator(binding_setter9,"{DataSource.Users.idUser}");
            bind_dir9 = new BindDirection(this.DataCursorActivity27,binding_getter9,binding_setter9,BindTargetType.ToInProperty);
            _flow.RESTActivityV212.InDirections.Add(bind_dir9);
            VTDPropertyInfoBase pi19 = new VTDPropertyInfoBase("Input.idUser");
            ...
            binding_setter10 = new StringFormaterDecorator(binding_setter10,"{Step.RESTInputProperties.RESTActivityV212.idUser}");
            bind_dir10 = new BindDirection(_flow.RESTActivityV212,binding_getter10,binding_setter10,BindTargetType.ToInProperty);
            _flow.RESTActivityV212.InDirections.Add(bind_dir10);
...
@"<Arguments><ResponseHttpVersion></ResponseHttpVersion><StatusCode>200</StatusCode><StatusDescription></StatusDescription><ResponseBody></ResponseBody><ResponseBodyAsBase64></ResponseBodyAsBase64></Arguments>");
            ...
            _flow.IfElseBranch17.Condition += delegate(object sender,EventArgs e)
            {
            	try
            	{
            VTDPropertyInfoBase pi21 = new VTDPropertyInfoBase("StatusCode");
            VTDBaseGetter binding_getter11 = new VTDObjectGetter(pi21);
            		System.Int32 expr00 = (System.Int32)HP.ST.Fwk.RunTimeFWK.Utilities.Utils.ConvertValue(_flow.RESTActivityV28.GetParam(binding_getter11),typeof(System.Int32));
            		var result0 = expr00;
            ...
            _flow.IfElseBranch20.Condition += delegate(object sender,EventArgs e)
            {
            	try
            	{
            VTDPropertyInfoBase pi22 = new VTDPropertyInfoBase("StatusCode");
            VTDBaseGetter binding_getter12 = new VTDObjectGetter(pi22);
            		System.Int32 expr00 = (System.Int32)HP.ST.Fwk.RunTimeFWK.Utilities.Utils.ConvertValue(_flow.RESTActivityV212.GetParam(binding_getter12),typeof(System.Int32));
            		var result0 = expr00;
            		System.Int32 result1 = (System.Int32)(200);
            		return (result0 == result1);
            	}
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV29.Input.Token = @"{Step.ResponseJsonBody.RESTActivityV28.access_token}";
            _flow.RESTActivityV29.Input.Token = @"{Step.ResponseJsonBody.RESTActivityV28.access_token}";
            VTDPropertyInfoBase pi23 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='access_token'][1]");
            VTDBaseGetter binding_getter13 = new VTDJsonGetter(pi23);
            VTDPropertyInfoBase pi24 = new VTDPropertyInfoBase("Input.Token");
            VTDBaseSetter binding_setter11 = new VTDObjectSetter(pi24);
            binding_setter11 = new StringFormaterDecorator(binding_setter11,"{Step.ResponseJsonBody.RESTActivityV28.access_token}");
            bind_dir11 = new BindDirection(_flow.RESTActivityV28,binding_getter13,binding_setter11,BindTargetType.ToInProperty);
            _flow.RESTActivityV29.InDirections.Add(bind_dir11);
            VTDPropertyInfoBase pi25 = new VTDPropertyInfoBase("Input.Token");
            VTDBaseGetter binding_getter14 = new VTDObjectGetter(pi25);
            VTDPropertyInfoBase pi26 = new VTDPropertyInfoBase("RequestHeaders[0].Value");
            VTDBaseSetter binding_setter12 = new VTDObjectSetter(pi26);
            binding_setter12 = new StringFormaterDecorator(binding_setter12,"{Step.RESTInputProperties.RESTActivityV29.Token}");
            bind_dir12 = new BindDirection(_flow.RESTActivityV29,binding_getter14,binding_setter12,BindTargetType.ToInProperty);
            _flow.RESTActivityV29.InDirections.Add(bind_dir12);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV210.Input.refresh_token = @"{Step.ResponseJsonBody.RESTActivityV28.refresh_token}";
            _flow.RESTActivityV210.Input.refresh_token = @"{Step.ResponseJsonBody.RESTActivityV28.refresh_token}";
            VTDPropertyInfoBase pi27 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='refresh_token'][1]");
            VTDBaseGetter binding_getter15 = new VTDJsonGetter(pi27);
            VTDPropertyInfoBase pi28 = new VTDPropertyInfoBase("Input.refresh_token");
            VTDBaseSetter binding_setter13 = new VTDObjectSetter(pi28);
            binding_setter13 = new StringFormaterDecorator(binding_setter13,"{Step.ResponseJsonBody.RESTActivityV28.refresh_token}");
            bind_dir13 = new BindDirection(_flow.RESTActivityV28,binding_getter15,binding_setter13,BindTargetType.ToInProperty);
            _flow.RESTActivityV210.InDirections.Add(bind_dir13);
            VTDPropertyInfoBase pi29 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='refresh_token'][1]");
            VTDBaseGetter binding_getter16 = new VTDJsonGetter(pi29);
            VTDPropertyInfoBase pi30 = new VTDPropertyInfoBase("Input.refresh_token");
            VTDBaseSetter binding_setter14 = new VTDObjectSetter(pi30);
            binding_setter14 = new StringFormaterDecorator(binding_setter14,"{Step.ResponseJsonBody.RESTActivityV28.refresh_token}");
            bind_dir14 = new BindDirection(_flow.RESTActivityV28,binding_getter16,binding_setter14,BindTargetType.ToInProperty);
            _flow.RESTActivityV210.InDirections.Add(bind_dir14);
            VTDPropertyInfoBase pi31 = new VTDPropertyInfoBase("Input.refresh_token");
            VTDBaseGetter binding_getter17 = new VTDObjectGetter(pi31);
            VTDPropertyInfoBase pi32 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter15 = new VTDObjectSetter(pi32);
            binding_setter15 = new StringFormaterDecorator(binding_setter15,"{Step.RESTInputProperties.RESTActivityV210.refresh_token}");
            bind_dir15 = new BindDirection(_flow.RESTActivityV210,binding_getter17,binding_setter15,BindTargetType.ToInProperty);
            _flow.RESTActivityV210.InDirections.Add(bind_dir15);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV211.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV210.access_token}";
            _flow.RESTActivityV211.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV210.access_token}";
            VTDPropertyInfoBase pi33 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='access_token'][1]");
            VTDBaseGetter binding_getter18 = new VTDJsonGetter(pi33);
            VTDPropertyInfoBase pi34 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseSetter binding_setter16 = new VTDObjectSetter(pi34);
            binding_setter16 = new StringFormaterDecorator(binding_setter16,"{Step.ResponseJsonBody.RESTActivityV210.access_token}");
            bind_dir16 = new BindDirection(_flow.RESTActivityV210,binding_getter18,binding_setter16,BindTargetType.ToInProperty);
            _flow.RESTActivityV211.InDirections.Add(bind_dir16);
            VTDPropertyInfoBase pi35 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseGetter binding_getter19 = new VTDObjectGetter(pi35);
            VTDPropertyInfoBase pi36 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter17 = new VTDObjectSetter(pi36);
            binding_setter17 = new StringFormaterDecorator(binding_setter17,"{Step.RESTInputProperties.RESTActivityV211.access_token}");
            bind_dir17 = new BindDirection(_flow.RESTActivityV211,binding_getter19,binding_setter17,BindTargetType.ToInProperty);
            _flow.RESTActivityV211.InDirections.Add(bind_dir17);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV215.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV212.access_token}";
            _flow.RESTActivityV215.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV212.access_token}";
            VTDPropertyInfoBase pi37 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='access_token'][1]");
            VTDBaseGetter binding_getter20 = new VTDJsonGetter(pi37);
            VTDPropertyInfoBase pi38 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseSetter binding_setter18 = new VTDObjectSetter(pi38);
            binding_setter18 = new StringFormaterDecorator(binding_setter18,"{Step.ResponseJsonBody.RESTActivityV212.access_token}");
            bind_dir18 = new BindDirection(_flow.RESTActivityV212,binding_getter20,binding_setter18,BindTargetType.ToInProperty);
            _flow.RESTActivityV215.InDirections.Add(bind_dir18);
            VTDPropertyInfoBase pi39 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseGetter binding_getter21 = new VTDObjectGetter(pi39);
            VTDPropertyInfoBase pi40 = new VTDPropertyInfoBase("RequestHeaders[0].Value");
            VTDBaseSetter binding_setter19 = new VTDObjectSetter(pi40);
            binding_setter19 = new StringFormaterDecorator(binding_setter19,"{Step.RESTInputProperties.RESTActivityV215.access_token}");
            bind_dir19 = new BindDirection(_flow.RESTActivityV215,binding_getter21,binding_setter19,BindTargetType.ToInProperty);
            _flow.RESTActivityV215.InDirections.Add(bind_dir19);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV213.Input.refresh_token = @"{Step.ResponseJsonBody.RESTActivityV212.refresh_token}";
            _flow.RESTActivityV213.Input.refresh_token = @"{Step.ResponseJsonBody.RESTActivityV212.refresh_token}";
            VTDPropertyInfoBase pi41 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='refresh_token'][1]");
            VTDBaseGetter binding_getter22 = new VTDJsonGetter(pi41);
            VTDPropertyInfoBase pi42 = new VTDPropertyInfoBase("Input.refresh_token");
            VTDBaseSetter binding_setter20 = new VTDObjectSetter(pi42);
            binding_setter20 = new StringFormaterDecorator(binding_setter20,"{Step.ResponseJsonBody.RESTActivityV212.refresh_token}");
            bind_dir20 = new BindDirection(_flow.RESTActivityV212,binding_getter22,binding_setter20,BindTargetType.ToInProperty);
            _flow.RESTActivityV213.InDirections.Add(bind_dir20);
            VTDPropertyInfoBase pi43 = new VTDPropertyInfoBase("Input.refresh_token");
            VTDBaseGetter binding_getter23 = new VTDObjectGetter(pi43);
            VTDPropertyInfoBase pi44 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter21 = new VTDObjectSetter(pi44);
            binding_setter21 = new StringFormaterDecorator(binding_setter21,"{Step.RESTInputProperties.RESTActivityV213.refresh_token}");
            bind_dir21 = new BindDirection(_flow.RESTActivityV213,binding_getter23,binding_setter21,BindTargetType.ToInProperty);
            _flow.RESTActivityV213.InDirections.Add(bind_dir21);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV214.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV213.access_token}";
            _flow.RESTActivityV214.Input.access_token = @"{Step.ResponseJsonBody.RESTActivityV213.access_token}";
            VTDPropertyInfoBase pi45 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Object'][1]/*[local-name(.)='access_token'][1]");
            VTDBaseGetter binding_getter24 = new VTDJsonGetter(pi45);
            VTDPropertyInfoBase pi46 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseSetter binding_setter22 = new VTDObjectSetter(pi46);
            binding_setter22 = new StringFormaterDecorator(binding_setter22,"{Step.ResponseJsonBody.RESTActivityV213.access_token}");
            bind_dir22 = new BindDirection(_flow.RESTActivityV213,binding_getter24,binding_setter22,BindTargetType.ToInProperty);
            _flow.RESTActivityV214.InDirections.Add(bind_dir22);
            VTDPropertyInfoBase pi47 = new VTDPropertyInfoBase("Input.access_token");
            VTDBaseGetter binding_getter25 = new VTDObjectGetter(pi47);
            VTDPropertyInfoBase pi48 = new VTDPropertyInfoBase("Url");
            VTDBaseSetter binding_setter23 = new VTDObjectSetter(pi48);
            binding_setter23 = new StringFormaterDecorator(binding_setter23,"{Step.RESTInputProperties.RESTActivityV214.access_token}");
            bind_dir23 = new BindDirection(_flow.RESTActivityV214,binding_getter25,binding_setter23,BindTargetType.ToInProperty);
            _flow.RESTActivityV214.InDirections.Add(bind_dir23);
